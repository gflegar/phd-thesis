...
numerical instability, and needs a suboptimal \ha{suboptimal?} \gf{clarify...}
...
factorization process~\cite{demmel}. \ha{maybe explain what
...
$O(n^2)$ operations to solve the system for one right hand side \ha{Again
    you should add some more details. Which triangular systems? Sure I know it,
    but where do you state it?} \gf{? I didn't mention any triangular systems
    here...}
